...
@client.command(description="Invoke the braincell")
async def ai(ctx, question: discord.Option(str, "What is your question?")):
    prediction = sentience.predict(model, question)
    print(prediction)
